function DrawPlaneZ2(w)
%DrawPlaneS Resposible to draw the 's' plane

    axes1 = 0;
    axes2 = 6;

    global rec1_handle circHandle circ2Handle X1axes_handle X2axes_handle ...
    ...
    if isempty(circ2Handle)
        circ2Handle = rectangle(...
            'Position',[axes2, -0.5, 1, 1],...
            'Curvature',[1, 1],...   
            'LineWidth',1,...
            'FaceColor',0.8*[1,1,1],...
            'EdgeColor',[0,0,0]);  %Darker version of color
